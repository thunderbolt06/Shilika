...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.shilikajain.com/article-2' },
  openGraph: {
    title: 'APAC PR Playbook 2026: Korea, Japan, Vietnam, India',
    ...
    url: 'https://www.shilikajain.com/article-2',
    type: 'article',
...
export default function Page() {
  ...
  return (
    <>
      <Script id="article-2-jsonld" type="application/ld+json" strategy="beforeInteractive" dangerouslySetInnerHTML={{ __html: jsonLd }} />

...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.shilikajain.com/article-5' },
  openGraph: {
    title: 'How to Get Featured in CoinDesk in 2026: Pitch Guide',
    ...
    url: 'https://www.shilikajain.com/article-5',
    type: 'article',
...
export default function Page() {
  ...
  return (
    <>
      <Script id="article-5-jsonld" type="application/ld+json" strategy="beforeInteractive" dangerouslySetInnerHTML={{ __html: jsonLd }} />
